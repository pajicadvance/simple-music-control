...
public class MinecraftMixin {
    ...
    private Music allowSituationalMusicInCreative(Music original) {
        return ModClientConfig.situationalMusicInCreative ? ClientMain.pickRandomSituationalMusic(player).orElse(player.level().getBiome(player.blockPosition()).value().getBackgroundMusic().orElse(
                //? if 1.21.4
